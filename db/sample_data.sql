...
('Joseph Hall', 'joseph.h@email.com', '246 Harbor Rd, Region'),
('Nicole King', 'nicole.k@email.com', '135 Port Ave, Area');

-- Insert Sample Data for Borrowings
-- Dilakukan MANUAL, disesuaikan dengan ID yang terbentuk ototmatis dari tabel MEMBERS / BOOKS
